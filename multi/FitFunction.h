...
FitFunction::FitFunction(Int_t numElements)
{
	...
	batemanFitFunctions[3] = Test1DecayByActivity;
	integralFitFunctions[3] = Test1DecayByActivityIntegral;
}
...
Double_t FitFunction::Test1DecayByActivity(Double_t *x, Double_t *par)
{
	...
	Double_t Test30 = par[4];
	Double_t lambdaTest3 = par[5];
	Double_t Test10 = par[6];
	Double_t lambdaTest1 = par[7];

	Double_t f = (Test10 * lambdaTest1 * (TMath::Exp(-lambdaTest1 * timeVar)));

	f += (Test10 * lambdaTest1 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest2-lambdaTest1)*(lambdaTest3-lambdaTest1)*(lambdaTest1-lambdaTest1))));
	f += (Test10 * lambdaTest1 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest2 * timeVar)) / ((lambdaTest1-lambdaTest2)*(lambdaTest3-lambdaTest2)*(lambdaTest1-lambdaTest2))));
	f += (Test10 * lambdaTest1 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest3 * timeVar)) / ((lambdaTest1-lambdaTest3)*(lambdaTest2-lambdaTest3)*(lambdaTest1-lambdaTest3))));
	f += (Test10 * lambdaTest1 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest1-lambdaTest1)*(lambdaTest2-lambdaTest1)*(lambdaTest3-lambdaTest1))));

	f += (Test20 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest2 * timeVar)) / ((lambdaTest3-lambdaTest2)*(lambdaTest1-lambdaTest2))));
	f += (Test20 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest3 * timeVar)) / ((lambdaTest2-lambdaTest3)*(lambdaTest1-lambdaTest3))));
	f += (Test20 * lambdaTest1 * lambdaTest2 * lambdaTest3 * ((TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest2-lambdaTest1)*(lambdaTest3-lambdaTest1))));

	f += (Test30 * lambdaTest1 * lambdaTest3 * ((TMath::Exp(-lambdaTest3 * timeVar)) / ((lambdaTest1-lambdaTest3))));
	f += (Test30 * lambdaTest1 * lambdaTest3 * ((TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest3-lambdaTest1))));
...
Double_t FitFunction::Test1DecayByActivityIntegral(Double_t *x, Double_t *par)
{
	...
	f += Test10 * lambdaTest2 * lambdaTest3 * lambdaTest1 * (1.0 - TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest2-lambdaTest1)*(lambdaTest3-lambdaTest1)*(lambdaTest1-lambdaTest1));
	f += Test10 * lambdaTest1 * lambdaTest3 * lambdaTest1 * (1.0 - TMath::Exp(-lambdaTest2 * timeVar)) / ((lambdaTest1-lambdaTest2)*(lambdaTest3-lambdaTest2)*(lambdaTest1-lambdaTest2));
	f += Test10 * lambdaTest1 * lambdaTest2 * lambdaTest1 * (1.0 - TMath::Exp(-lambdaTest3 * timeVar)) / ((lambdaTest1-lambdaTest3)*(lambdaTest2-lambdaTest3)*(lambdaTest1-lambdaTest3));
	f += Test10 * lambdaTest1 * lambdaTest2 * lambdaTest3 * (1.0 - TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest1-lambdaTest1)*(lambdaTest2-lambdaTest1)*(lambdaTest3-lambdaTest1));

	f += Test20 * lambdaTest3 * lambdaTest1 * (1.0 - TMath::Exp(-lambdaTest2 * timeVar)) / ((lambdaTest3-lambdaTest2)*(lambdaTest1-lambdaTest2));
	f += Test20 * lambdaTest2 * lambdaTest1 * (1.0 - TMath::Exp(-lambdaTest3 * timeVar)) / ((lambdaTest2-lambdaTest3)*(lambdaTest1-lambdaTest3));
	f += Test20 * lambdaTest2 * lambdaTest3 * (1.0 - TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest2-lambdaTest1)*(lambdaTest3-lambdaTest1));

	f += Test30 * lambdaTest1 * (1.0 - TMath::Exp(-lambdaTest3 * timeVar)) / ((lambdaTest1-lambdaTest3));
	f += Test30 * lambdaTest3 * (1.0 - TMath::Exp(-lambdaTest1 * timeVar)) / ((lambdaTest3-lambdaTest1));
