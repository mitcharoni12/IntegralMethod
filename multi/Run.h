...
void Run::CreateTotalBatemanMultiRunHistos()
{
    ...
    for(int i = 0; i < numElements; i++)
    {
        ...
        totalBatemanMultiRunFitHisto[i] = new TH1D("Fitted Bateman Method Values", "Fitted Bateman Method Values", 500, parameterValue*0, parameterValue*2.5);
...
void Run::CreateTotalIntegralMultiRunHistos()
{
    ...
    for(int i = 0; i < numElements; i++)
    {
        ...
        totalIntegralMultiRunFitHisto[i] = new TH1D("Fitted Integral Method Values", "Fitted Integral Method Values", 500, parameterValue*0, parameterValue*2.5);
