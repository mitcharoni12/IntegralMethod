...
void Run::CreateTotalBatemanMultiRunHistos()
{
    ...
    for(int i = 0; i < numElements; i++)
    {
        ...
        totalBatemanMultiRunFitHisto[i] = new TH1D("Fitted Bateman Method Values", (elementNameStrs[i] + " Fit Result Total Bateman Histo").c_str(), 500, parameterValue*0, parameterValue*2.5);
...
void Run::CreateTotalIntegralMultiRunHistos()
{
    ...
    for(int i = 0; i < numElements; i++)
    {
        ...
        totalIntegralMultiRunFitHisto[i] = new TH1D("Fitted Integral Method Values", (elementNameStrs[i] + " Fit Result Total Integral Histo").c_str(), 500, parameterValue*0, parameterValue*2.5);
